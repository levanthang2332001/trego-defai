...
export async function borrowTokensWithEchelon(
  aptos: Aptos,
  account: Account,
  ...
  try {
    ...
    const COIN_STANDARD_DATA: InputGenerateTransactionPayloadData = {
      function:
        '0xc6bc659f1649553c1a3fa05d9727433dc03843baac29473c817d06d39e7621ba::scripts::borrow',
    ...
    const FUNGIBLE_ASSET_DATA: InputGenerateTransactionPayloadData = {
      function:
        '0xc6bc659f1649553c1a3fa05d9727433dc03843baac29473c817d06d39e7621ba::scripts::borrow_fa',
      functionArguments: FUNCTIONAL_ARGS_DATA,
    };
