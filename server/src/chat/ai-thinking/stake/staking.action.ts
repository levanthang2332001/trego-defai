import { ActionType, StakingParams } from 'src/chat/entities/intent.entity';
import { AbstractBaseAction } from '../base/base-action';
import { aptosAgent } from 'src/utils/aptosAgent';
import { getTokenByTokenName } from 'src/utils/token';
import { stakeTokensWithThala } from 'src/tools/thala/stake';
import { ChatResponse } from 'src/chat/entities/chat.entity';

export class StakingAction extends AbstractBaseAction {
